...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
    <main class="card-container slideUp-animation">
        <div class="image-container">
            ...
            <p class="quote">Log in to get exciting offers..!</p>
        ...
        <form action="logindb.jsp" method="post">
            <div class="form-container slideRight-animation">
                ...
                <div class="input-container">
                    ...
                    <input type="text" name="U-name" id="f-name" required>
                    <span>
                        Username
                    </span>
                    <div class="error"></div>
                ...
                <div id="btm">
                    ...
                    <p class="btm-text">
                       Don't have an account??<span class="btm-text-highlighted">  <a href="signup.jsp">signup</a></span>
                    </p>
                </div>
            </div>
        </form>
